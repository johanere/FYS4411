...
RBM::RBM(int GD_iters,int m, int n, double learningrate, double sigma) {
  m_random = new Random();
  m_GDiters=GD_iters;
  m_M=m;
  m_N=n;
...
RBM::RBM(int GD_iters,int m, int n, double learningrate,double sigma, int seed){
