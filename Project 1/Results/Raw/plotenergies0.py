...
outdata=["BF_Energies.dat","IS_Energies.dat"]#, "IS_Energies_low.dat","IS_Energies_high.dat"]
lab=["Brute Force", "$\\Delta = 0.3$ "]#, "$\\Delta 0.1", "$\\Delta 1.0"]
...
for j in range(len(outdata)):
    ...
    #plot
    start_plot=int(round(step*0.05))
