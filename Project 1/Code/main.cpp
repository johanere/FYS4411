...
int main(int argc, char* argv[]) {
  ...
  int numberOfParticles,method,interaction,eliptical,GD_iters,para;
  ...
  // read from command line
    ...
    //system
      ...
      //      alpha = 0.496; // initial value for alpha
    double  a                = 0.0043;
    ...
    int     runs=125; //how many varyations on alpha - use 9 for full spectre alpha
    ...
    double run_E_min=0;
      ...
      filename.append(to_string(para));
